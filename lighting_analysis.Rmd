...
Take a moment to inspect the resulting file [out/plots.pdf](out/plots.pdf):
...
Finally, filter our crashes to those occurring at night, and create a "crash_lighting" attribute, based on the metadata in [docs/PA_Crashes_Data_Dictionary.pdf](docs/PA_Crashes_Data_Dictionary.pdf):
